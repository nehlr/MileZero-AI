...
Projenin anlatımını ve canlı demosunu içeren sunum videosunu izlemek veya bilgisayarınıza indirmek için:
👉 [**Sunum Videosunu İndir / İzle (sunum.MP4)**](https://github.com/nehlr/MileZero-AI/raw/main/sunum.MP4)
